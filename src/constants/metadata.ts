export const siteMetadata = {
  title: 'Torres Sistemas',
  category: 'technology',
  theme: 'system',
  siteUrl: 'https://torressistemas.vercel.app/',
  authors: [{ name: 'Iuri Torres', url: 'https://github.com/iuritorres' }],
  description: `A Torres Sistemas é uma agência de criação de sites com 5+ anos de experiência no ramo. Nosso foco é ajudar empresas a estabelecer uma presença online sólida e eficaz. Como especialistas em desenvolvimento web, oferecemos soluções personalizadas para atender às necessidades específicas de cada cliente.
  ...
  youtube: 'https://www.youtube.com/channel/UCoTWXGqXvuL-u6vAad4ezBQ',
